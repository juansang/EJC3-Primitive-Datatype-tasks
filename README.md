...
```
New-Item -Path C:\jsanc\PowerShell\Workshop1 -Name dir3 -ItemType Directory
New-Item -Path C:\jsanc\PowerShell\Workshop1\dir3\ -Name Testfile.txt -ItemType File
```
...
```
Add-Content -Path C:\jsanc\PowerShell\Workshop1\dir3\Testfile.txt -Value False
Add-Content -Path C:\jsanc\PowerShell\Workshop1\dir3\Testfile.txt -Value "Primer string"
Add-Content -Path C:\jsanc\PowerShell\Workshop1\dir3\Testfile.txt -Value 34
```

## Task 5
#### Read from the text file and use “Get-Member” to find the datatype returned
```
Get-Content -Path C:\jsanc\PowerShell\Workshop1\dir3\Testfile.txt | Get-Member
```
